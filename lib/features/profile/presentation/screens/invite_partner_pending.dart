      ...
      child: partnerAsync.when(
        data: (partner) => Column(
          children: [
            ...
            Text(
              l10n.partnerInvitationPendingTitle,
              style: AppText.h2,
              textAlign: TextAlign.center,
            ),
            const SizedBox(height: 10),
            Text(
              l10n.partnerInvitationPendingDescription,
        ...
        error: (_, __) => Center(child: Text(l10n.unableToLoadInvitation)),
      ),
    );
  }
}
